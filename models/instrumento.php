...
class Instrumento {
	...
	public static function count() {
		...
		$db = Db::getInstance();
		$result_count = $db->query("SELECT COUNT(*) AS number FROM Instrumento");
	...
	public static function create($id, $nome) {
		...
		$db = DB::getInstance();
		$query_insert = "INSERT INTO Instrumento VALUES ('$id', '$nome')";
	...
	public static function retrieve($order,$page,$number_of_records) {
		...
		//Query
		$query_select = "SELECT * FROM Instrumento ORDER BY $order LIMIT $startpoint,$number_of_records";
